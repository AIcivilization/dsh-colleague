...
> 照搬 AionUi (aionui.com) 设计系统，SPDX-License-Identifier: Apache-2.0
>
...
| 变量 | Light | Dark | 用途 |
|------|-------|------|------|
| `--aou-1` | `#eff0f6` | `#2a2a2a` | 最浅 — 大面积底色 |
| `--aou-2` | `#e5e7f0` | `#3d4150` | 浅 — 禁用态背景 |
| `--aou-3` | `#d1d5e5` | `#525a77` | |
| `--aou-4` | `#b5bcd6` | `#6a749b` | 悬停态 |
| `--aou-5` | `#97a0c5` | `#838fba` | |
| `--aou-6` | `#7583b2` | `#a1aacb` | **品牌主色** |
| `--aou-7` | `#596590` | `#b5bcd6` | |
| `--aou-8` | `#3f4868` | `#d1d5e5` | 选中态 |
| `--aou-9` | `#262c41` | `#e5e7f0` | |
| `--aou-10` | `#0d101c` | `#eff0f6` | 最深 |
...
AionUi 使用像素级精确间距，不使用 Tailwind 默认的 4px 基数倍数。
